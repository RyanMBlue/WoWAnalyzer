...
import SPELLS_SHAMAN from 'common/SPELLS/shaman';
...
// prettier-ignore
export default [
  change(date(2026, 9, 18), <>Added <SpellLink spell={SPELLS_SHAMAN.THUNDERSTORM} /> to the spellbook so its casts show on the timeline.</>, LittleBoyBlu),
